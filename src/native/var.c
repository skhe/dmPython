    ...
    else 
    {
        ...
        if(paramdesc->param_type == DSQL_PARAM_OUTPUT && var->output_stream == 1)
        {
            rt = dpi_bind_param2(var->boundCursorHandle, var->boundPos, DSQL_PARAM_OUTPUT_STREAM, var->type->cType,
                ...
                (dpointer)(ulength)var->boundPos, var->bufferSize, var->indicator, var->actualLength);
        }
        else
        {
...
{    
    ...
    {
        //bug584776����������10G��������INT�������ֵ���������Ϊһ��С��2G��ֵ���Ӷ����ֶβ���ɹ�����Ԥ�ڱ�������
        //��udint8�Ȼ�ȡ�󶨲������ȣ�������INT_MAX���ֵ���򱨴��������ٸ�ֵ���������
    ...
    if (PyLong_Check(value))
    {
        ...
        /* ����INT_MAX�����ֵ��Ҳ��Ϊ��BIGINT��LINUXpyLong_asLong��������LONG_MAX(bigint������) */
    ...
    //pythonֻ��double���ͣ���������ֵֻ��Ӧ��vt_Double, vt_Float�Ƕ�Ӧfloat���͵ģ����ﲻ��
...
{        
    ...
    /*��valueת��Ϊvar->data��������var->indicator[arrayPos]*/
...
{
    /* ��long string or long binary->DSQL_DATA_AT_EXEC */
